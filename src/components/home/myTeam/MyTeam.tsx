...
import ChoosePlayerList, {choosePlayersListState, searchState} from "./choosePlayerList/ChoosePlayerList";
...
import {axiosDeletePlayer, axiosFantasyTeam, axiosPlayersList, axiosWeekInf} from "../../../global/ApiCalls";
...
export function MyTeam({showingTab}: { showingTab: 'schematic' | 'list' }) {
    ...
    return (
        <div id={'my-team-main-div'}>
            ...
            <ChoosePlayerList playerListApiCall={playerListApiCall} updateGameInfo={updateGameInfo}/>
