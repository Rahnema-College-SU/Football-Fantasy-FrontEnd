...
import {getShowingMyTeamTabsStateId, setShowingMyTeamTabsState} from "../../../../global/Storages";
...
export function MiddleTabBar() {
    ...
    const [selectedTab, setSelectedTab] = useState<number>(getShowingMyTeamTabsStateId())
