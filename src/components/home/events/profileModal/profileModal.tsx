        ...
        <div className='profile-modal-div' style={{display:profileModalDisplay}} onClick={e => {e.stopPropagation();}} >
            ...
            <img className="modal-profile-photo" src={profilePhoto} alt="profile photo"></img>
                ...
                <div className='modal-profile-info'>
                    <div className='info-lable'>نام:<div className='info'>اسم</div></div>
                    
                    <div className='info-lable'>سن:<div className='info'>۵۸</div></div>

                    <div className='info-lable'>کشور:<div className='info'>ایران</div></div>

                    <div className='info-lable'>آخرین امتیاز:<div className='info'>۱۱۲</div></div>
                </div>
            </div>
